...
local hour_format = "!%H:%M:%S"
local nohour_format = "%M:%S"
local force_hours = false

function get_format(count)
    return (force_hours or count > 3599) and hour_format or nohour_format
end
...
function script_properties()
    ...
    obs.obs_properties_add_bool(props, "display_hour", "Always Display Hours")
...
function script_update(settings)
	...
	force_hours = obs.obs_data_get_bool(settings, "display_hour")
    format = obs.obs_data_get_string(settings, "format") or default_format
